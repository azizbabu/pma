    ...
    <nav class="navbar-custom">
        ...
        <ul class="list-inline float-right mb-0">
            <li class="list-inline-item dropdown notification-list d-none">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-arrow dropdown-menu-lg d-none">
                    <!-- item-->
            ...
            <li class="list-inline-item dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                    ...
                    <a class="dropdown-item d-none" href="#"><i class="mdi mdi-lock-open-outline m-r-5 text-muted"></i> Lock screen</a>
